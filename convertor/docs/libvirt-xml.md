...
As described in [libvirt](https://libvirt.org/docs.html), we can use 
libvirt to manage VM using the below XMLs (generated by our algorithm).

### [Domain.xml(aka VirtualMachine)](https://libvirt.org/formatdomain.html)
...
### [Network.xml(aka VirtualNetwork)](https://libvirt.org/formatnetwork.html)
...
### [storage.xml(aka VirtualDisk)](https://libvirt.org/formatstorage.html)
